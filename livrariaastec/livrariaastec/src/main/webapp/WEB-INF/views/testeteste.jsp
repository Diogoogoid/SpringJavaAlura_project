...
<!-- Bootstrap style --> 
	<link id="callCss" rel="stylesheet" media="screen" href="<c:url value='themes/bootshop/bootstrap.min.css' />">
...
<!-- fav and touch icons -->
    <link rel="shortcut icon" href="WEB-INF/views/themes/images/ico/favicon.ico">
